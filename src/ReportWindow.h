...
class ReportWindow : public ReportWindowBase
{
  ...
  public:
    ReportWindow(wxWindow *parent, ConfigContainer *config, wxWindowID id = wxID_ANY, const wxString &title = _("MeteoVache"),
                 const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxSize(497, 445),
                 long style = wxMINIMIZE_BOX | wxMAXIMIZE_BOX | wxRESIZE_BORDER | wxCAPTION | wxCLOSE_BOX | wxCLIP_CHILDREN | wxSTAY_ON_TOP |
                              wxTAB_TRAVERSAL);
    ~ReportWindow();
